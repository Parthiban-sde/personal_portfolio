    ...
    <section id="experience" className="py-32 bg-gradient-to-b from-slate-900 to-slate-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-20 group relative p-10 bg-gradient-to-br from-slate-800 via-slate-800/50 to-slate-900 rounded-3xl border border-cyan-400/30 shadow-2xl overflow-hidden hover:shadow-cyan-500/20 transition-all duration-500">
            <div className={`absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl`}></div>
            <div className="absolute -top-1/2 right-0 w-80 h-80 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 group-hover:animate-float-up"></div>
            ...
            <div className="relative flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="flex-1">
                <h3 className="text-3xl font-bold text-white mb-3 group-hover:text-cyan-200 transition-colors duration-300">Data Analyst Intern</h3>
                <p className="text-xl text-cyan-300 font-semibold mb-3">Qwixpert Consulting</p>
                <p className="text-gray-400 mb-6 text-lg">March 2025 - May 2025 | Bangalore, Karnataka</p>
